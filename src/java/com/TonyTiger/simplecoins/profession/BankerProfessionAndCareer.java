...
public class BankerProfessionAndCareer {
	...
	public static ITradeList[] trades = {
			...
			new EntityVillager.ListItemForEmeralds(new ItemStack(ModItems.IRONCOIN,RandNum(21,27)), new PriceInfo(1,1)),
			new EntityVillager.ListItemForEmeralds(new ItemStack(ModItems.GOLDCOIN,RandNum(24,30)), new PriceInfo(1,1))
	};
